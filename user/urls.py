...
from .views import GuestRegistrationView,OwnerRegistrationView, UserLoginView, OwnerDashboardView, GuestDashboardView, UserRegistrationChoiceView,GuestProfileUpdationView, OwnerProfileUpdationView, PGAvailStatusUpdationView, AdminDashboardView,AdminProfileUpdationView, AdminRegistrationView
