...
from .views import PGCreateView,PGListView,PGDeleteView,PGUpdateView,PGDetailView, PGAmenitiesAddView, PGAmenitiesUpdateView, PGAmenitiesDetailView, PGImagesAddView, PGCommentView, PGCommentsDeleteView, ContactOwnerView,AdminPGListView ,ContactOwnerSuccessView#,PGAvailStatusUpdateView
...
urlpatterns = [    
    ...
    path('admin/pg/list',AdminPGListView.as_view(),name = 'admin_pg_list'),
